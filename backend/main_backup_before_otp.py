...
SESSION_SAME_SITE = os.getenv(
    "GAPINO_SESSION_SAME_SITE",
    "none" if COOKIE_SECURE else "lax",
).strip().lower()

if SESSION_SAME_SITE not in {
    "lax",
    "strict",
    "none",
}:
...
if SESSION_SAME_SITE == "none" and not COOKIE_SECURE:
...
allowed_origins = [
    ...
    "https://amirhosein12233.github.io",
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "http://localhost:5500",
    "http://127.0.0.1:5500",
...
async def get_messages(
    ...
    for message in messages:
        ...
        if (
            (
                sender == str(user1)
                and receiver == str(user2)
            )
            or
            (
                sender == str(user2)
                and receiver == str(user1)
            )
        ):
...
# =========================================================
# PRIVATE MESSAGE HTTPS FALLBACK
# =========================================================
